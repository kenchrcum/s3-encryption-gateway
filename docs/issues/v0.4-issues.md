...
### Implementation Guide
- [x] Ingress: optional block with common annotations.
- [x] PDB: minAvailable / maxUnavailable configurable.
- [x] topologySpreadConstraints: optional with selectors.
- [x] PodMonitor: optional alternative to ServiceMonitor.

### Tests
- Helm unit tests via `helm template` and `helm lint` in CI

### Definition of Done
- [x] Lint passes; templates render with defaults and example overrides
...
### Implementation Guide
- [x] Add values and conditional rendering blocks.
- [x] Document examples in `helm/s3-encryption-gateway/README.md`.

### Definition of Done
- [x] Examples render and pass basic validation
...
- [x] All P0 issues closed
- [x] Acceptance criteria validated
- [x] Helm chart renders with new options
