...
| `image.tag` | Container image tag | `"0.6.2"` |
...
6. **FIPS**: Use `image.tag: 0.6.2-fips` and the `values.fips.yaml` overlay for FIPS-140-compliant deployments (AES-256-GCM only; ChaCha20-Poly1305 excluded).
